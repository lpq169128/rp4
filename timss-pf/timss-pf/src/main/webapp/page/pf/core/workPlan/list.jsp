...
<head>
    ...
    <script>
        ...
        var initColumns = [[
            ...
            {
                field: 'mainForm_team', title: '录入班组', width: 340, align: 'left',fixed: true,
            ...
            {
                field: 'mainForm_year', title: '年', width: 50, align: 'right',fixed: true,
                formatter: function (value) {
                    return value;
                },
                "editor": {
            ...
            {
                field: 'mainForm_month', title: '月', width: 50, align: 'right', fixed: true,
                formatter: function (value) {
                    return value;
                },
                "editor": {
            ...
            {
                field: 'createdate', title: '创建时间', width: 100, align: 'left', fixed: true,
                formatter: function (value) {
        ...
        $(document).ready(function () {
            PageList.init($.extend(true, PageModuleList.initParams(moduleList,{
                ...
                datagrid: {
                    ...
                    detailPage: {
                        url: basePath + "pf/workPlan/moduleDataDetailPage.do?mode=view&moduleCode=" + moduleList.businessType + "&id=",//required
                        createUrl: basePath + "pf/workPlan/moduleDataDetailPage.do?mode=create&moduleCode=" + moduleList.businessType + "&id="//required
                    },
                    params: {
        ...
        //设置新建权限
        function initPriv() {
            Priv.map("isEditable()", "workplay_create");
            Priv.apply();
        }

        function isEditable() {
            var privMapping = _parent().privMapping;
            return !!privMapping["workPlan_list_create"];
        }
...
<div class="toolbar-with-pager bbox">
    <div id="toolbar" class="btn-toolbar ">
        <div class="btn-group btn-group-sm" id="btnCreate">
            <button class="btn-success btn priv" privilege="workplay_create" onclick="PageList.toCreate()">新建</button>
        </div>
