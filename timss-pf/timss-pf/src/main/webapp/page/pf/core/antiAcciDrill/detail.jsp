...
<head>
    ...
    <script type="text/javascript">
        ...
        console.log("userResponsibilityID:"+userResponsibilityID)
        ...
        $(document).ready(function () {
            ...
            $("#f_takePartPerson").parent().click(function () {
                getSucUser("mainForm");
            })
        ...
        function setSucUserForDialog(formId) {
            ...
            if (typeof(data.sucUser) != "undefined" && data.sucUser != null && data.sucUser != "") {
                ...
                participantName = data.takePartPerson.split(",");
            }
            var schedulePerson = {};
        ...
        function saveSucUserForDialogToFrom(formId) {
            ...
            $("#" + formId).iForm("setVal", {"takePartPerson": strName, "sucUser": strId});
            console.log("!!11!11111"+$("#f_takePartPerson").val())
        }
