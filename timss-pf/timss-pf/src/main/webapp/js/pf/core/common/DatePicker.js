...
Calendar.prototype.style = function () {
    ...
    strStyle += ".calendar .day li{font-weight:bold;} .calendar .date li{background-color:#fff;}";
    ...
    strStyle += ".calendarTitle{background:#fff;text-align:center;height:20px;line-height:20px;clear:both;width:100%;}";
...
Calendar.prototype.draw = function () {
    ...
    var lis = "<div id='calendar' class='calendar' style='background-color:white;width:";
    if ("d" == this.type) {
        lis += "300";
    } else {
        lis += "200";
