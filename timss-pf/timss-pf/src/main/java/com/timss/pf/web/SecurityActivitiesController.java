...
@Controller
@RequestMapping(value = "pf/securActivities")
public class SecurityActivitiesController extends ModuleDataController {
    protected SecurityActivitiesService service;
    @Autowired
    ...
    @Autowired
    protected void setAccidentEnvisionService(SecurityActivitiesService service) throws Exception {
        this.service = service;
        this.setService(service);
    }
    public SecurityActivitiesController() {
    }
    /*
     * 重新设定页面资源所在的路径前缀
     **/
