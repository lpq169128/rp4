...
@Controller
@RequestMapping(value = "pf/workRecord")
public class WorkRecordController extends ModuleDataController {
    protected WorkRecordService service;
    @Autowired
    ...
    @Autowired
    protected void setWorkRecordService(WorkRecordService service) throws Exception {
