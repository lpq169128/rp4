...
@Controller
@RequestMapping(value = "pf/workPlan")
public class WorkPlanController extends ModuleDataController {
    protected WorkPlanService service;
    @Autowired
    ...
    @Autowired
    protected void setWorkPlanService(WorkPlanService service) throws Exception {
