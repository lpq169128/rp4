 ...
 */
@Controller
@RequestMapping(value = "pf/acciEnvision")
public class AccidentEnvisionController extends ModuleDataController {
    protected AccidentEnvisionService service;
    @Autowired
    ...
    @Autowired
    protected void setAccidentEnvisionService(AccidentEnvisionService service) throws Exception {
        this.service = service;
        this.setService(service);
    }
    public AccidentEnvisionController() {
    }
    /*
     * 重新设定页面资源所在的路径前缀
     **/
