...
@Controller
@RequestMapping(value = "pf/workArrangement")
public class WorkArrangementController extends ModuleDataController {
    protected WorkArrangementService service;
    @Autowired
    ...
    @Autowired
    protected void setWorkArrangementService(WorkArrangementService service) throws Exception {
        this.service = service;
        this.setService(service);
    }
    public WorkArrangementController() {
    }
    /*
     * 重新设定页面资源所在的路径前缀
     **/
