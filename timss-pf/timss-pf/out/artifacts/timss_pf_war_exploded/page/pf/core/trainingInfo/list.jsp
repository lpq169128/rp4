...
<head>
    ...
    <script src="${basePath}/js/pf/core/trainingInfo/trainingInfoList.js?ver=${iVersion}"></script>
        ...
        $(document).ready(function () {
            PageList.init({
                datagrid: {
                    id: "tabList",//required
                    detailPage: {
                        url: basePath + "pf/trainingInfo/detailPage.do?mode=view&id=",//required
                        createUrl: basePath + "pf/trainingInfo/detailPage.do?mode=create&id=",//required
                        idPrefix: "trainingInfo",//详情页面id前缀，后面加_详情项id
                        namePrefix: "培训记录"//详情页面名称前缀，后面加详情项名称
                    },
                    params: {
                        idField: "trainingId",//required
                        nameField: "businessNo",//required
                        url: basePath + "pf/trainingInfo/getList.do",//required,
